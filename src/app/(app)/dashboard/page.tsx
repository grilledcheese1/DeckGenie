...
import { useRightRail } from '@/components/shell/AppShellSlots'
...
export default function DashboardPage() {
  ...
  useRightRail(<DashboardRightRail />)
  ...
  // of this page reflects the change. `Sidebar` shares this same
  // `useProgress()` instance (via `ProgressProvider` in the shared layout),
  // so `reload()` here updates the one `settings` object Sidebar's chip
  // reads too — no separate cross-component sync needed.
  //
